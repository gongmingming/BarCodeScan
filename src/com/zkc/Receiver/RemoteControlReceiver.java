...
public class RemoteControlReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		} else if (action.equals("android.intent.action.SCREEN_ON")) { //屏幕被打开之后的广播
		...
		} else if (action.equals("android.intent.action.SCREEN_OFF")) { //屏幕被关闭之后的广播
		...
		} else if (action.equals("android.intent.action.ACTION_SHUTDOWN")) { //关闭系统时发出的广播
